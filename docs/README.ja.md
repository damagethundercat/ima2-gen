...
<p align="center">
  <a href="../assets/screenshots/tutorial1-readme.mp4">
    <img src="../assets/screenshots/tutorial1-readme.gif" alt="ima2-genX 43秒のチュートリアル動画">
  </a>
  <br>
  <a href="../assets/screenshots/tutorial1-readme.mp4"><strong>43秒のチュートリアル動画を見る</strong></a>
</p>
...
![Multimode workflow with Prompt Builder, candidate slots, active job history, and follow-up controls](../assets/screenshots/multimode.png)
...
Prompt Builder は intent を generation-ready prompt に整え、Prompt library は reusable prompt material を保存します。強化された Library 画面では imported prompts をより見つけやすく、検索しやすくなっています。Library は local files、GitHub folders、curated sources、GPT-image hint packs から import でき、import した prompts は local index に保存されます。

![Prompt library workspace with reusable prompts, search, tags, and import controls](../assets/screenshots/prompt-library.png)
